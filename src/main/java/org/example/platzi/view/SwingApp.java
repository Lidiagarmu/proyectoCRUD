...
public class SwingApp extends JFrame {
    ...
    public SwingApp() {
        ...
        //añade el panel de botones al marco
        ...
        agregarButton.setOpaque(true); //Asegura que el color de fondo se aplique al botón.
        agregarButton.setBorderPainted(false); //Opcionalmente elimina el borde del botón para evitar cualquier conflicto visual.
